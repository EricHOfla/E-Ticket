                            ...
                            <div class="payment-method-header">
                                <div class="thumb">
                                    ...
                                    <div class="avatar-edit">
                                        ...
                                        <label for="image" class="bg-info"><i class="la la-pencil"></i></label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg-info">@lang('Range')</h5>
                                            <div class="card-body">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg-info">@lang('Charge')</h5>
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <h5 class="card-header bg-info">@lang('Deposit Instruction')</h5>
                                            <div class="card-body">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg-info  text-white">@lang('User data')
